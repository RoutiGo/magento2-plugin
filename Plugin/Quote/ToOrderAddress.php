...
{
    public function afterConvert($subject, $result, Address $address, $data = [])
    {
        if ($address->getRoutigoDeliveryDate()) {
            $result->setRoutigoDeliveryDate($address->getRoutigoDeliveryDate());
        }

        if ($address->getRoutigoTimeframesFee()) {
